...
def test_sm120_direct_mqa_logits_block_d_uses_full_indexer_head_tile():
    assert sm12x_mqa._fp8_mqa_logits_block_d(32) == 64
    assert sm12x_mqa._fp8_mqa_logits_block_d(64) == 64
    assert sm12x_mqa._fp8_mqa_logits_block_d(128) == 128
    assert sm12x_mqa._fp8_mqa_logits_block_d(256) == 128
...
def test_sm120_mqa_direct_topk_uses_triton_logits_when_logits_fit(
