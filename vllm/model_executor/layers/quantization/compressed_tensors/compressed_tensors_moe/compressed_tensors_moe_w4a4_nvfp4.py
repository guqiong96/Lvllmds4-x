...
class CompressedTensorsW4A4Nvfp4MoEMethod(CompressedTensorsMoEMethod):
    ...
    def create_weights(
        ...
        **extra_weight_attrs,
        ...
        w13_weight_scale_2 = torch.nn.Parameter(
            torch.empty(num_experts, w13_num_shards, dtype=torch.float32, device=device),
            requires_grad=False,
        )
    ...
    def get_fused_moe_quant_config(self, layer: torch.nn.Module) -> FusedMoEQuantConfig:
        return make_nvfp4_moe_quant_config(
            ...
            w13_scale=layer.w13_weight_scale,
            w2_scale=layer.w2_weight_scale,
             w13_scale_2=layer.w13_weight_scale_2 if hasattr(layer, "w13_weight_scale_2") else layer.w13_weight_global_scale,
            w2_scale_2=layer.w2_weight_scale_2 if hasattr(layer, "w2_weight_scale_2") else layer.w2_weight_global_scale,
            a13_scale=layer.w13_input_scale if hasattr(layer, "w13_input_scale") else layer.w13_input_global_scale,
            a2_scale=layer.w2_input_scale if hasattr(layer, "w2_input_scale") else layer.w2_input_global_scale,
